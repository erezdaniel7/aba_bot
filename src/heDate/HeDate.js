...
HeDate.getTimeOfMoladRoshHshann = function (year) {
    ...
    var myTime = new HeDate.Time(numOfMonth * 29, numOfMonth * 12, numOfMonth * 793);
    //add the first molad.
    myTime.days += 2;
    myTime.hours += 5;
    myTime.parts += 204;
...
HeDate.getDayOfRoshHshan = function (year) {
    ...
    var myTime = HeDate.getTimeOfMoladRoshHshann(year);
...
HeDate.getyeartype = function (year) {
    var day = HeDate.getDayOfRoshHshan(year) + 354 + 30 * HeDate.IsLeapYear(year);
...
HeDate.prototype.setDate = function (day) {
    ...
    if (Math.abs(day) > 400)
        ...
        var monthLenngth = this.getMonthLength();
